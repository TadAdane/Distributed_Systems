...
public class NodeController {
    ...
    // Stores additional metadata for each node including neighbors
    ...
    // Updates neighbor metadata for every node based on sorted order
    ...
    // Class representing extended metadata for a node
